        ...
        <FadeIn.Item>
          <div className="flex flex-col text-center items-center justify-between mb-4">
            ...
            <h3 className="text-gray-800 text-lg mt-1 max-w-80">
              We&apos;re coming to support you in online presence and beyond ✨
            </h3>
          </div>
        </FadeIn.Item>
        <FadeIn.Item>
          <div className="w-full  justify-center flex gap-6 mt-6">
            <Link
              href={"https://www.instagram.com/arnawadigital"}
              target="_blank"
            >
              <svg

...
const Maintenance = () => {
  ...
  return (
    <div className="z-10 flex items-center justify-center py-4">
      ...
      >
        <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 text-center text-sm transition ease-out hover:text-gray-700 hover:duration-300 hover:dark:text-neutral-400">
          {isMobile ? (
            <span>⚒️ Website is Under Maintenance ⚒️</span>
          ) : (
            <span>👷‍♂️⚒️✨ Our Website is Currently Under Maintenance ✨⚒️👷‍♂️</span>
          )}
        </AnimatedShinyText>
      </div>
    </div>
